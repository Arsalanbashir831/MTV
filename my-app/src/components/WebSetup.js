...
const WebSetup = () => {
  return (
    <div id="ccc_web"><div class="ccc_box"><h1 class="ccc_title">Get IPTV on your browser</h1> <h2 class="ccc_subtitle">Indulge in great TV on all your devices.</h2> <button onClick={()=>window.location.href=''} class="ccc_btn_open">
        OPEN IN BROWSER
